...
const TAILLE_DATA: Record<string, {
  ...
  'auto-entrepreneur': {
    ...
    logicielsRecommandes: {
      ...
      serrurier: ['tolteck', 'obat', 'axonaut'],
      plaquiste: ['tolteck', 'obat', 'progbat'],
      vitrier: ['tolteck', 'obat', 'axonaut'],
      etancheur: ['tolteck', 'progbat', 'obat'],
      charpentier: ['tolteck', 'progbat', 'obat'],
      zingueur: ['tolteck', 'obat', 'progbat'],
      terrassier: ['tolteck', 'progbat', 'batigest'],
      paysagiste: ['tolteck', 'obat', 'axonaut'],
      pisciniste: ['tolteck', 'obat', 'axonaut'],
      alarmiste: ['tolteck', 'axonaut', 'obat'],
      ascensoriste: ['batigest', 'axonaut', 'obat'],
      facadier: ['tolteck', 'obat', 'progbat'],
    },
  },
  'artisan-seul': {
    emoji: '🔧',
    ...
    logicielsRecommandes: {
      ...
      serrurier: ['obat', 'tolteck', 'axonaut'],
      ...
      terrassier: ['progbat', 'obat', 'batigest'],
      paysagiste: ['obat', 'tolteck', 'axonaut'],
      pisciniste: ['obat', 'tolteck', 'axonaut'],
      alarmiste: ['obat', 'axonaut', 'tolteck'],
      ascensoriste: ['obat', 'batigest', 'axonaut'],
  ...
  'equipe-2-5': {
    ...
    logicielsRecommandes: {
      ...
      serrurier: ['obat', 'axonaut', 'batigest'],
      plaquiste: ['obat', 'batigest', 'progbat'],
      vitrier: ['obat', 'axonaut', 'batigest'],
      etancheur: ['obat', 'batigest', 'progbat'],
      charpentier: ['obat', 'batigest', 'progbat'],
      zingueur: ['obat', 'batigest', 'progbat'],
      terrassier: ['batigest', 'progbat', 'axonaut'],
      paysagiste: ['obat', 'axonaut', 'batigest'],
      pisciniste: ['obat', 'axonaut', 'batigest'],
      alarmiste: ['axonaut', 'obat', 'batigest'],
      ascensoriste: ['batigest', 'axonaut', 'ebp'],
      facadier: ['obat', 'batigest', 'progbat'],
    },
  },
  'pme-5-15': {
    emoji: '🏢',
    ...
    logicielsRecommandes: {
      ...
      serrurier: ['axonaut', 'batigest', 'ebp'],
      plaquiste: ['batigest', 'ebp', 'progbat'],
      vitrier: ['axonaut', 'batigest', 'ebp'],
      etancheur: ['batigest', 'progbat', 'ebp'],
      charpentier: ['batigest', 'progbat', 'ebp'],
      zingueur: ['batigest', 'progbat', 'ebp'],
      terrassier: ['batigest', 'ebp', 'progbat'],
      paysagiste: ['axonaut', 'batigest', 'ebp'],
      pisciniste: ['axonaut', 'batigest', 'ebp'],
      alarmiste: ['axonaut', 'sellsy', 'batigest'],
      ascensoriste: ['batigest', 'ebp', 'axonaut'],
      facadier: ['batigest', 'progbat', 'ebp'],
    },
  },
};
