        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href={`/${data.slug}#criteres`} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-smooth">
                Critères
              </a>
              <a href={`/${data.slug}#faq`} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-smooth">
                FAQ
              </a>
            </nav>
            <ThemeToggle />
        ...
        <div className="relative h-full flex items-end">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 pb-16">
            ...
            <motion.h1
              ...
              className="text-5xl md:text-6xl font-bold tracking-tight text-foreground mb-4 leading-tight"
            >
              Le meilleur logiciel pour
              <br />
              <span className="text-muted-foreground">les {data.nomPluriel}.</span>
            </motion.h1>
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-3 text-lg">
                  Votre quotidien, en {data.problemesQuotidiens.length} points
                </h3>
        ...
        >
          <div className="mb-8">
            <div className="inline-flex items-center space-x-2 text-sm font-medium text-muted-foreground mb-3">
              ...
              <span>Le verdict de notre analyse</span>
            </div>
            <h2 className="text-4xl font-bold tracking-tight text-foreground mb-4 leading-tight">
              Deux profils,
              <br />
              <span className="text-muted-foreground">deux logiciels.</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              Il n'y a pas de "meilleur logiciel dans l'absolu". Tout dépend de la taille de votre équipe et de votre façon de travailler.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <div className="absolute -top-3 left-6 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                POUR ARTISANS SEULS
              </div>
              ...
              <div className="text-sm text-muted-foreground mb-4">
                <strong className="text-foreground">Idéal pour :</strong> {logiciels.obat.idealPour}
              </div>
            ...
            >
              ...
              <div className="text-sm text-muted-foreground mb-4">
                <strong className="text-foreground">Idéal pour :</strong> {logiciels.axonaut.idealPour}
              </div>
              <p className="text-muted-foreground mb-6 leading-relaxed text-sm">
                {data.verdictAxonaut}
              </p>
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Oubliez les critères génériques. Voici ce que les {data.nomPluriel.toLowerCase()} regardent vraiment avant de choisir.
            </p>
          </div>
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`rounded-full w-10 h-10 flex items-center justify-center font-bold text-sm flex-shrink-0 ${
                    critere.importance === 'critique' 
                      ? 'bg-red-500 text-white' 
                      : critere.importance === 'important'
        ...
        <motion.section
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-foreground rounded-2xl p-8 md:p-12 text-background mb-16"
        >
          <Quote className="w-12 h-12 text-background/30 mb-6" />
          <p className="text-xl md:text-2xl leading-relaxed mb-8 text-background">
            "{data.temoignage.texte}"
          </p>
          <div className="flex items-center space-x-4">
            <div className="w-14 h-14 rounded-full bg-background/10 flex items-center justify-center text-background font-bold text-lg">
              {data.temoignage.prenom[0]}{data.temoignage.initiale}.
            </div>
            <div>
              <div className="font-semibold text-background">
                {data.temoignage.prenom} {data.temoignage.initiale}.
              </div>
              <div className="text-sm text-background/70">
                {data.nom} à {data.temoignage.ville} • {data.temoignage.anneesExperience} ans d'expérience
              </div>
            </div>
          </div>
        </motion.section>
        ...
        >
          <div className="mb-8 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              En moyenne, un {data.nom.toLowerCase()} passe {data.tempsAdminParSemaine}h par semaine sur l'admin. Faisons le calcul.
            </p>
          </div>
          <ROICalculator />
        </motion.section>
        ...
        >
          <div className="mb-8 text-center">
            <div className="inline-flex items-center space-x-2 text-sm font-medium text-muted-foreground mb-3">
              ...
              <span>Questions spécifiques au métier</span>
            </div>
            <h2 className="text-4xl font-bold tracking-tight text-foreground mb-4 leading-tight">
              Vos questions,
              <br />
        ...
        >
          <div className="mb-8 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              3 questions pour confirmer votre choix en 30 secondes.
            </p>
          </div>
          <Quiz />
        </motion.section>
        ...
        <motion.section
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-card rounded-xl border-2 border-yellow-500 p-8 mb-16"
        >
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Pour automatiser votre comptabilité avec {logiciels.obat.nom} ou {logiciels.axonaut.nom}, 
                nous recommandons <strong className="text-foreground">Qonto</strong>. 
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-muted-foreground">
                Projet éditorial indépendant — Aucune participation financière des éditeurs.
              </p>
            </div>
            <div>
